// AudioEngine is a wrapper for the FMOD Core API
// Created by Robert Savaglio and being used in BLAZARK with his permisssion
...
public:
	...
	//// Events ////
	AudioEvent& CreateAudioEvent(const std::string& strEventName, const std::string& GUID);
